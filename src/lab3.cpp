...
int UHD_SAFE_MAIN(int argc, char* argv[])
{
    ...
    desc.add_options()
        ...
        ("rx-gain", po::value<double>(&rx_gain)->default_value(30), "gain for the receive RF chain")
        ...
        ("rx-cap-len", po::value<int>(&rx_cap_len)->default_value(1000), "Tx side down-sampling factor")
